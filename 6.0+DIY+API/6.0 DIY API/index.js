...
app.get("/random", (req, res) => {
  ...
  res.status(200).json({ satus: "successful", message: jokes[randomNumber] });
});
...
app.get("/jokes/:id", (req, res) => {
  ...
  res.status(200).json({ status: "successful", foundJoke });
});
...
app.get("/filter", (req, res) => {
  ...
  res.status(200).json({ status: "successful", filteredJoke });
});
//4. POST a new joke
app.post("/jokes", (req, res) => {
  ...
  res.status(200).json({ status: "successful", newJoke });
});
//5. PUT a joke
app.put("/jokes/:id", (req, res) => {
  ...
  res.status(200).json({ status: "successful", replacementJoke });
});
//6. PATCH a joke
...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (searchIndex > -1) {
    ...
    res.status(200).json({ status: "successful", deletedJoke });
  } else {
    res.status(404).json({
      status: "unsuccessful, not found",
      message: `joke with the id ${id} was not found. No jokes were deleted`,
    });
  }
});
//8. DELETE All jokes
app.delete("delete-all", (req, res) => {
  ...
  if (userKey === masterKey) {
    ...
    res
      .status(200)
      .json({ status: "successful", message: "all jokes are deleted" });
  } else {
    res.status(404).json({
      status: "unsuccessful",
